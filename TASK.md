...
- [ ] **T12. Vercel 배포** ← **현재 단계**
  - [x] 배포 전 품질 게이트 정리 — tsc ✅ / eslint ✅ / next build ✅ (2025-05-15)
  - [ ] Supabase Google OAuth provider 활성화 (대시보드 작업)
  - [ ] Redirect URL 등록 (`/auth/callback`)
  - [ ] Vercel 환경변수 주입 (`NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`)
  - [ ] Vercel 배포 후 Google 로그인 E2E 테스트
  - [ ] 커스텀 도메인 연결
